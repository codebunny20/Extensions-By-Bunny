    ...
    function initConverter() {
      const unitCategories = {
        length: {
          ...
          mm: { name: "Millimeters", toBase: (v) => v / 1e3, fromBase: (v) => v * 1e3 },
        ...
        mass: {
          ...
          t: { name: "Metric tons", toBase: (v) => v * 1e6, fromBase: (v) => v / 1e6 }
        },
        temperature: {
        ...
        time: {
          ms: { name: "Milliseconds", toBase: (v) => v / 1e3, fromBase: (v) => v * 1e3 },
        ...
        area: {
          ...
          ha: { name: "Hectares", toBase: (v) => v * 1e4, fromBase: (v) => v / 1e4 },
        ...
        volume: {
          ...
          m3: { name: "Cubic meters", toBase: (v) => v * 1e3, fromBase: (v) => v / 1e3 },
        ...
        energy: {
          ...
          kWh: { name: "Kilowatt-hours", toBase: (v) => v * 36e5, fromBase: (v) => v / 36e5 }
        },
        power: {
          W: { name: "Watts", toBase: (v) => v, fromBase: (v) => v },
          kW: { name: "Kilowatts", toBase: (v) => v * 1e3, fromBase: (v) => v / 1e3 },
          mW: { name: "Milliwatts", toBase: (v) => v / 1e3, fromBase: (v) => v * 1e3 },
          hp: { name: "Horsepower", toBase: (v) => v * 745.7, fromBase: (v) => v / 745.7 },
          MW: { name: "Megawatts", toBase: (v) => v * 1e6, fromBase: (v) => v / 1e6 }
        },
        angle: {
        ...
        frequency: {
          ...
          kHz: { name: "Kilohertz", toBase: (v) => v * 1e3, fromBase: (v) => v / 1e3 },
          MHz: { name: "Megahertz", toBase: (v) => v * 1e6, fromBase: (v) => v / 1e6 },
          GHz: { name: "Gigahertz", toBase: (v) => v * 1e9, fromBase: (v) => v / 1e9 },
          rpm: { name: "Revolutions/min", toBase: (v) => v / 60, fromBase: (v) => v * 60 }
        },
        force: {
          N: { name: "Newtons", toBase: (v) => v, fromBase: (v) => v },
          kN: { name: "Kilonewtons", toBase: (v) => v * 1e3, fromBase: (v) => v / 1e3 },
