...
const ttsEnabledInput = getRequiredElement("ttsEnabled");
const autoSpeakInput = getRequiredElement("autoSpeak");
const ttsRateInput = getRequiredElement("ttsRate");
const ttsPitchInput = getRequiredElement("ttsPitch");
const ttsVolumeInput = getRequiredElement("ttsVolume");
const ttsRateValue = getRequiredElement("ttsRateValue");
const ttsPitchValue = getRequiredElement("ttsPitchValue");
const ttsVolumeValue = getRequiredElement("ttsVolumeValue");
const speakBtn = getRequiredElement("speakBtn");
const stopBtn = getRequiredElement("stopBtn");
const ttsStatus = getRequiredElement("ttsStatus");
const ttsPanel = getRequiredElement("ttsPanel");
